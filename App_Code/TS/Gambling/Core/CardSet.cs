...
namespace TS.Gambling.Core
{
    ...
    public abstract class CardSet
    {
        ...
        public static Dictionary<string, Card> LONG_BURA_CARDS = new Dictionary<string, Card>()
        {
            ...
            {"10_Spades", new Card("10_Spades", CardType.Spade, 14, 10)},
            {"Jack_Spades", new Card("Jack_Spades", CardType.Spade, 11, 2)},
            {"Queen_Spades", new Card("Queen_Spades", CardType.Spade, 12, 3)},
            {"King_Spades", new Card("King_Spades", CardType.Spade, 13, 4)},
            {"Ace_Spades", new Card("Ace_Spades", CardType.Spade, 15, 11)},
            ...
            {"10_Clubs", new Card("10_Clubs", CardType.Club, 14, 10)},
            {"Jack_Clubs", new Card("Jack_Clubs", CardType.Club, 11, 2)},
            {"Queen_Clubs", new Card("Queen_Clubs", CardType.Club, 12, 3)},
            {"King_Clubs", new Card("King_Clubs", CardType.Club, 13, 4)},
            {"Ace_Clubs", new Card("Ace_Clubs", CardType.Club, 15, 11)},
            ...
            {"10_Diamonds", new Card("10_Diamonds", CardType.Diamond, 14, 10)},
            {"Jack_Diamonds", new Card("Jack_Diamonds", CardType.Diamond, 11, 2)},
            {"Queen_Diamonds", new Card("Queen_Diamonds", CardType.Diamond, 12, 3)},
            {"King_Diamonds", new Card("King_Diamonds", CardType.Diamond, 13, 4)},
            {"Ace_Diamonds", new Card("Ace_Diamonds", CardType.Diamond, 15, 11)},
            ...
            {"10_Hearts", new Card("10_Hearts", CardType.Heart, 14, 10)},
            {"Jack_Hearts", new Card("Jack_Hearts", CardType.Heart, 11, 2)},
            {"Queen_Hearts", new Card("Queen_Hearts", CardType.Heart, 12, 3)},
            {"King_Hearts", new Card("King_Hearts", CardType.Heart, 13, 4)},
            {"Ace_Hearts", new Card("Ace_Hearts", CardType.Heart, 15, 11)},
        };
